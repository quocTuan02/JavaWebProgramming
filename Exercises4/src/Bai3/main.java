package Bai3;
/*
    Trung tâm Aptech thực hiện trao học bổng cho các học viên xu ất sắc và đáp ứng đủ các yêu cầu sau:
...
d/ Các kì thi chỉ thi lần đầu tiên
    Các dữ liệu 1 2 3 4 của 1 học viên được nhập từ bàn phím.
